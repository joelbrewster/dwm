...
static const char col_bg[]          = "#1e2022";
static const char col_gray1[]       = "#3c3e44";
static const char col_gray2[]       = "#bbc3c8";
static const char col_highlight[]   = "#3498d8";
/*static const char col_highlight[]   = "#2eb398"; */
...
static const Rule rules[] = {
	...
	{ "xfce4-notes",  NULL,       NULL,       0,            True,        -1 },
};
...
static const char *dmenucmd[]     = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_bg, "-nf", col_gray1, "-sb", col_highlight, "-sf", col_gray2, NULL };
